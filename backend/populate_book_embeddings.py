"""
Script to populate book_embeddings collection with mock data
"""
import os
import sys
import uuid
...
COLLECTION_NAME = 'book_embeddings'  # Changed to the correct collection
        ...
        try:
            ...
            point = {
                ...
                'payload': {
                    ...
                    'text': chapter['content'][:500] + '...',  # Truncate for storage
